...
| `metadata1` | String | Yes || Optional variable to attach key-value data to the payment object. |
| `metadata2` | String | Yes || Optional variable to attach key-value data to the payment object. |
